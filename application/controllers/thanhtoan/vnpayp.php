...
class vnpay extends CI_Controller {
	...
	public function index()
	{
		...
		$vnp_TmnCode = "W7CEXRYJ"; //Website ID in VNPAY System 
		$vnp_HashSecret = "JQDDQOEJMIQCFIAFHZXZYABYITFULOLM"; //Secret key 
		$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
		$vnp_Returnurl = "http://localhost/nhom7/xu-ly-thanh-toan";
