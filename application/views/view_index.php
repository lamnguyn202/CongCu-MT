			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<?php echo base_url('/static/'); ?>images/phone.png" alt=""></div>(+84)0932720254</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="<?php echo base_url('/static/'); ?>images/mail.png" alt=""></div><a href="email:nhathaoxxx000@gmail.com">nhathaoxxx000@gmail.com</a></div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="<?php echo base_url(); ?>">Nhóm 7</a></div>
						</div>
					</div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li><a href="<?php echo base_url('/trend/'); ?>">Trend 2024<i class="fas fa-chevron-right"></i></a></li>
								</ul>
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="trends_container">
						...
						<div class="trends_text"><p>Các sản phẩm đang được ưa chuộng trong 2024!</p></div>
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_column footer_contact">
						<div class="logo_container">
							<div class="logo"><a href="#">Nhóm 7</a></div>
						</div>
						<div class="footer_title">Liên hệ với chúng tôi 24/7</div>
						<div class="footer_phone">(+84)0932720254</div>
				...
				<div class="col-lg-2 offset-lg-2">
					<div class="footer_column">
						...
						<ul class="footer_list">
							...
							<li><a href="<?php echo base_url('trend/'); ?>">Xu Hướng 2024</a></li>
						</ul>
					</div>
				</div>
...
Nhóm 7 &copy;<script>document.write(new Date().getFullYear());</script> Bản quyền thuộc <i class="fa fa-heart" aria-hidden="true"></i> <a href="<?php echo base_url(); ?>">Nhóm 7</a> 
...
<script>
	var base_url =  window.location.origin == "http://localhost" ? window.location.origin + "/nhom7" : window.location.origin
