                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <?php
                                                if ($getDoanhThuHomQua[0]["doanhThuHomQua"] !== null) {
                                                    echo number_format($getDoanhThuHomQua[0]["doanhThuHomQua"], 0, '', ',') . ' đ';
                                                } else {
                                                    echo 'Hôm qua chưa có đơn thanh toán trực tiếp nào';
                                                }
                                                ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $dauNgayToiGioValue = $dauNgayToiGio[0]["dauNgayToiGio"];
                                                if ($dauNgayToiGioValue !== null) {
                                                    echo number_format($dauNgayToiGioValue, 0, '', ',') . ' đ';
                                                } else {
