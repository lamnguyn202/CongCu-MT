                            ...
                            <?php foreach ($news as $key => $value): ?>
                               	<tr class="odd">
                                    ...
                                    <td style="line-height: 50px;">
                                        ...
                                        <a href="<?php echo base_url('admin/tin-tuc/xoa/').$value['tinTucId'] . '/'; ?>" class="btn btn-danger deleteProductAction" data-toggle="modal" data-target="deleteNewsModal">Xóa</a>
                                    </td>
                            	</tr>
                            <?php endforeach ?>
                        </tbody>
